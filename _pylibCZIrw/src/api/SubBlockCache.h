...
/// This POD ("plain-old-data") structure represents all options for configuring a subblock cache
...
/// This POD ("plain-old-data") structure represents information on a subblock cache.
struct SubBlockCacheInfo
{
    std::uint32_t elementsCount = 0;    ///< Number of elements (subblocks) in the cache
